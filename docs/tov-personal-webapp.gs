...
function sendEmail(data, sheet, row) {
  ...
  const subject = `[토브 개인] 새 시공 문의 — ${name} / ${region || '지역미상'}`;
...
<div style="font-family: -apple-system, 'Apple SD Gothic Neo', 'Noto Sans KR', sans-serif; max-width: 580px; margin: 0 auto; background: #ffffff;">
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background: #1a2e22;">
    <tr>
      ...
      <td style="padding: 18px 32px; font-size: 10px; color: #6b9e7e; letter-spacing: 2px; text-transform: uppercase; text-align: right; white-space: nowrap;">Personal Lead</td>
    </tr>
  </table>
  ...
  <div style="background: #eef6f0; border-left: 3px solid #5a9e6e; padding: 9px 24px; font-size: 12px; color: #2d5a3f; letter-spacing: 0.3px;">
    새로운 시공 문의가 접수되었습니다 — ${safe(submissionDate)}
  </div>
  ...
  <div style="padding: 24px 28px 20px;">
    ...
    <p style="margin: 0 0 18px 0;">
      <span style="font-size: 12px; color: #666666; letter-spacing: 0.3px;">${safe(region)}</span>
    </p>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="background: #fafafa; border-radius: 2px;">
      <tr>
        <td style="padding: 10px 14px;">
          ...
          <span style="font-size: 12px; color: #333333; margin-left: 6px;">개인</span>
        </td>
  ...
  <div style="background: #fafafa; border-top: 1px solid #f0f0f0; padding: 12px 28px; text-align: center;">
    <p style="font-size: 10px; color: #888888; margin: 0; line-height: 1.6; letter-spacing: 0.3px;">토브 인테리어 자동 알림 · Make Automation</p>
  </div>
...
`;
  ...
  try {
    ...
    console.error(`[텔레그램] 발송 실패 (${row}행):`, error);
    throw error;
  }
}
